...
use Callcocam\PapaLeguas\Support\Shinobi\Contracts\Role;
use Callcocam\PapaLeguas\Support\Shinobi\Models\Role as ModelsRole;
...
trait HasRoles
{
    ...
    {
        return $this->belongsToMany(config('shinobi.models.role', ModelsRole::class))->withTimestamps();
    }
    ...
    {
        return app()->make(config('shinobi.models.role', ModelsRole::class));
    }
}
