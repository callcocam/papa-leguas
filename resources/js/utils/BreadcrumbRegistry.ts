/**
 * BreadcrumbRegistry - Gerencia registro de componentes Breadcrumb
 *
 ...
 * BreadcrumbRegistry.register('breadcrumb-custom', CustomComponent)
 *
 * // Sobrescrever componente padrão
 * BreadcrumbRegistry.register('breadcrumb-default', MyBreadcrumbComponent)
 *
 * // Obter componente
 * const component = BreadcrumbRegistry.get('breadcrumb-default')
 */
...
class BreadcrumbRegistryClass {
   ...
   *
   * @param name Nome do componente (ex: 'breadcrumb-default')
...
export const BreadcrumbRegistry = new BreadcrumbRegistryClass()

// Exporta também a classe para testes
export { BreadcrumbRegistryClass }
