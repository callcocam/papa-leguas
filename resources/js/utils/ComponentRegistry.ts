/**
 * ComponentRegistry - Gerencia registro de componentes InfoList
 *
 ...
 * ComponentRegistry.register('info-column-custom', CustomComponent)
 *
 * // Sobrescrever componente padrão
 * ComponentRegistry.register('info-column-email', MyEmailComponent)
 *
 * // Obter componente
 * const component = ComponentRegistry.get('info-column-text')
 */
...
class ComponentRegistryClass {
   ...
   *
   * @param name Nome do componente (ex: 'info-column-text')
