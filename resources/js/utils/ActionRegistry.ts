/**
 * ActionRegistry - Gerencia registro de componentes de Action
 *
 ...
 * ActionRegistry.register('action-custom', CustomComponent)
 *
 * // Sobrescrever componente padrão
 * ActionRegistry.register('action-button', MyButtonComponent)
 *
 * // Obter componente
 * const component = ActionRegistry.get('action-button')
 */
...
class ActionRegistryClass {
   ...
   *
   * @param name Nome do componente (ex: 'action-button')
